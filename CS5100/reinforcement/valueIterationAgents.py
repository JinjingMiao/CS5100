...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        "*** YOUR CODE HERE ***"
        minValue = float("-inf")
        lenIter = self.iterations
        for i in range(lenIter):
          #print("asdfghj", self.iterations)
    ...
    def computeQValueFromValues(self, state, action):
        ...
        """
        "*** YOUR CODE HERE ***"
        action_prob_pair = self.mdp.getTransitionStatesAndProbs(state, action)
        action_prob_pairs = action_prob_pair
        total = 0
        nextTotal = 0
...
class AsynchronousValueIterationAgent(ValueIterationAgent):
    ...
    def runValueIteration(self):
        ...
        lenState = len(self.states)
        lenIter = self.iterations
        total =0
        for i in range(lenIter):
          s = self.states[i % lenState]
